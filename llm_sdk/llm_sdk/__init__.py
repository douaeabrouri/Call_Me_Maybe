...
class Small_LLM_Model:
    ...
    dtype: torch.dtype | None, default=None
        ...
        usage reasonable; on CPU we keep
        ``float32`` for maximum compatibility.
    """
    ...
    def get_logits_from_input_ids(self, input_ids: list[int]) -> list[float]:
        """
        Given a list of input token ids, return the
        raw logits (no softmax) for the next token.
        """
        ...
        # Get logits for the last token in the
        # sequence for the batch (batch size 1)
